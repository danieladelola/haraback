...
<body class="min-h-screen flex items-center justify-center p-4">
    ...
    <div class="w-full max-w-md z-10 fade-in">
        ...
        <!-- Registration Form -->
        <form method="POST" action="{{ route('user.register') }}" class="bg-white bg-opacity-80 backdrop-blur-lg rounded-xl p-8 glow-box border border-gray-200 transform hover:scale-[1.005] transition duration-500">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div class="relative">
                    ...
                    <input
                        ...
                        value="{{ old('firstname') }}"
                        required
                        class="w-full p-3 pl-10 bg-white bg-opacity-70 text-gray-800 border border-gray-300 rounded-md focus:outline-none input-glow"
                    >
                </div>
                <div class="relative">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                <div class="relative">
                    ...
                    <input
                        ...
                        required
                        class="w-full p-3 pl-10 pr-10 bg-white bg-opacity-70 text-gray-800 border border-gray-300 rounded-md focus:outline-none input-glow"
                        id="password-field"
                    >
            ...
            <div class="flex items-center mb-6">
                <input
                    ...
                    @checked(old('agree'))
                    name="agree"
                    class="mr-2 bg-white border-gray-300 rounded text-blue-500 focus:ring-blue-500"
                    required
                >
                <label for="agree" class="text-gray-600 text-sm">
                    I agree to the
                    <a href="#" class="text-blue-500 hover:text-blue-700">Terms</a> and
            ...
            <div class="text-center text-gray-600 text-sm">
                ...
                <a href="/user/login" class="text-blue-500 hover:text-blue-700 font-medium">Sign In</a>
            </div>
        </form>
