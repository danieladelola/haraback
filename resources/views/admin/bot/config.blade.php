            ...
            <form action="{{ route('admin.bot.config.stake') }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="minimum" name="minimum" step="any" required>
                    </div>
                    <div class="form-group">
                        <label for="maximum">@lang('Maximum')</label>
                        <input type="number" class="form-control" id="maximum" name="maximum" step="any" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" id="duration" name="duration" step="any" required>
                    </div>
                    <div class="form-group">
                        <label for="roi">@lang('ROI')</label>
                        <input type="number" class="form-control" id="roi" name="roi" step="any" required>
                    </div>
                </div>
        ...
        <div class="modal-content">
            <form action="{{ route('admin.bot.config.update', $staking->id) }}" method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="minimum">@lang('Minimum')</label>
                        <input type="number" class="form-control" id="minimum" name="minimum" value="{{ $staking->minimum }}" step="any" required>
                    </div>
                    <div class="form-group">
                        <label for="maximum">@lang('Maximum')</label>
                        <input type="number" class="form-control" id="maximum" name="maximum" value="{{ $staking->maximum }}" step="any" required>
                    </div>
                    <div class="form-group">
                        <label for="amount">@lang('Amount')</label>
                        <input type="number" class="form-control" id="amount" name="amount" value="{{ $staking->amount }}" step="any" required>
                    </div>
                    <div class="form-group">
                        <label for="duration">@lang('Duration')</label>
                        <input type="number" class="form-control" id="duration" name="duration" value="{{ $staking->duration }}" step="any" required>
                    </div>
                    <div class="form-group">
                        <label for="roi">@lang('ROI')</label>
                        <input type="number" class="form-control" id="roi" name="roi" value="{{ $staking->roi }}" step="any" required>
                    </div>
                    <div class="form-group">
