...
class SiteController extends Controller
{
    ...
    public function pusherAuthentication($socketId, $channelName)
    {
        ...
        $pusherSecret = @$pusherConfig->pusher_app_secret;
        ...
        return response()->json([
            ...
            'auth'    => @$pusherConfig->pusher_app_key . ":" . $hash,
        ]);
    }
    ...
    public function marketList(Request $request)
    {
        ...
        $query = CoinPair::active()->searchable(['symbol'])->select('id', 'market_id', 'coin_id', 'symbol');
